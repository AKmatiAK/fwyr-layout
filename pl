...
xkb_symbols "basic" {
    ...
    key <AE11>  { [ bracketleft, braceleft,       endash,       emdash ]  };
    key <AE12>  { [ bracketright, braceright,       endash,       emdash ]  };


    key <AD01>  { [         f,          F,     Greek_pi,  Greek_OMEGA ]  };
    key <AD02>  { [         b,          B,           oe,           OE ]  };
    key <AD03>  { [         d,          D,      eogonek,      Eogonek ]  };
    key <AD04>  { [         o,          O,       oacute,       Oacute ]  };
    key <AD05>  { [         p,          P,    copyright,   registered ]  };
    key <AD06>  { [     minus,      equal,         plus,    trademark ]  };
    key <AD07>  { [  asterisk, numbersign, periodcentered,        U2194 ]  };
    key <AD08>  { [         g,          G,       oacute,       Oacute ]  };
    key <AD09>  { [         w,          W,       oacute,       Oacute ]  };
    key <AD10>  { [         y,          Y, horizconnector,   multiply ]  };
    key <AD11>  { [         h,          H, periodcentered,   division ]  };
    key <AD12>  { [         q,          Q, dead_belowdot, dead_abovedot ] };

    key <AC01>  { [         j,          J,       cacute,       Cacute ]  };
    key <AC02>  { [         c,          C,       cacute,       Cacute ]  };
    key <AC03>  { [         i,          I,       lstroke,     Lstroke ]  };
    key <AC04>  { [         e,          E,      eogonek,      Eogonek ] };
    key <AC05>  { [         n,          N,       nacute,       Nacute ]  };
    key <AC06>  { [    period,      colon,       exclam,    Zabovedot ]  };
    key <AC07>  { [     comma,  semicolon,     question,       Aacute ]  };
    key <AC08>  { [         t,          T,       zacute,       Zacute ]  };
    key <AC09>  { [         r,          R, 		 zacute,	   Zacute ]  };
    key <AC10>  { [         a,          A,       aogonek,       Aogonek ]  };
    key <AC11>  { [         z,          Z,	  zabovedot,	Zabovedot ]  };
    key <AC12>  { [         s,          S,       sacute,       Sacute ]  };
    key <TLDE>  { [     grave, asciitilde,      notsign,    logicalor ]  };

    key <AB01>  { [         x,          X,    zabovedot,    Zabovedot ]  };
    key <AB02>  { [         v,          V,       zacute,       Zacute ]  };
    key <AB03>  { [         u,          U,       cacute,       Cacute ]  };
    key <AB04>  { [         m,          M, doublelowquotemark, leftsinglequotemark ] };
    key <AB05>  { [  slash, underscore, rightdoublequotemark, leftdoublequotemark ] };
    key <AB06>  { [ apostrophe,  quotedbl,       underscore,       Nacute ]  };
    key <AB07>  { [ backslash,        bar,           mu,     infinity ]  };
    key <AB08>  { [          l,        L, dead_diaeresis, dead_abovering ] };
    key <AB09>  { [          k,         K,   dead_tilde,  dead_macron ]  };
    key <AB10>  { [         x,          x,   dead_acute, dead_doubleacute ]  };
